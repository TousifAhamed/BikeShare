...
from best_model_finder import bikeshare_tuner
...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            model_data = pd.DataFrame(data.copy())
            print(data)
            ...
            data = preprocessor.remove_columns(
                data, ["instant", "dteday", "hum", "cnt", "registered", "casual"])
            """
            ...
            model_finder = bikeshare_tuner.Model_Finder(
            ...
            result = model_finder.get_best_model(
                x_train, y_train, x_test, y_test)
